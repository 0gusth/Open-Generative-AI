...
export default function DrawModal({
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/85 backdrop-blur-md p-4">
      {/* Modal Box */}
      <div className="relative w-full max-w-5xl bg-[#171719] border border-white/10 rounded-2xl flex flex-col shadow-[0_20px_50px_rgba(0,0,0,0.9)] overflow-hidden h-[90vh]">
        {/* Header Tab Selector */}
        <div className="flex items-center justify-between border-b border-white/5 p-4 shrink-0 bg-[#1d1d1f]">
          <div className="flex items-center gap-1.5 bg-[#131316]/60 border border-white/5 p-1 rounded-full select-none">
            ...
            >
              Sketch to Video
              <span className="bg-[#EF0328] text-white text-[8px] font-black px-1 rounded">
                NEW
              </span>
            </button>
            <button
        ...
        {/* Workspace Body */}
        <div className="flex-1 flex flex-col items-center justify-center p-6 overflow-y-auto custom-scrollbar relative bg-[#171719]/30">
          {viewState === "setup" ? (
            /* Setup Card */
            <div className="border-2 border-dashed border-white/10 rounded-2xl p-8 max-w-md w-full text-center flex flex-col items-center gap-6 bg-[#171719]/90">
              <div className="w-56 h-36 rounded-xl border border-white/5 overflow-hidden shadow-lg select-none relative bg-black/40">
                ...
                <div className="absolute bottom-2 left-2 right-2 bg-black/80 backdrop-blur-md rounded-md p-1 px-2 border border-white/5 flex items-center gap-1">
                  <div className="w-2.5 h-2.5 rounded-full bg-[#EF0328] animate-pulse"></div>
              ...
              <div className="flex flex-col gap-2.5 w-full max-w-[240px]">
                ...
                <button
                  ...
                  className="bg-[#1d1d1f]/[0.98] hover:bg-[#1c1c22] text-white border border-white/10 font-bold text-sm px-6 py-2.5 rounded-xl flex items-center justify-center gap-2 transition-all active:scale-95 shadow-inner"
                >
                  <svg
                    width="14"
                    height="14"
            ...
            <div className="flex-1 flex flex-col items-center justify-center w-full relative h-full">
              ...
              >
                ...
                >
                  ...
                  {canvasObjects
                    ...
                    .map((imgObj) => {
                      ...
                      return (
                        <div
                          key={imgObj.id}
                          className={`absolute group cursor-move ${isSelected ? "ring-2 ring-[#EF0328] ring-offset-1 ring-offset-black z-10" : ""}`}
                          style={{
                            left: `${leftPct}%`,
                            top: `${topPct}%`,
                            width: `${widthPct}%`,
                      ...
                      return (
                        <textarea
                          ...
                          className={`absolute bg-transparent border-none outline-none resize-none font-bold text-left overflow-hidden select-text z-10 ${
                            isSelected
                              ? "ring-1 ring-[#EF0328] ring-dashed bg-black/25"
                              : ""
                          }`}
                          style={{
                            left: `${leftPct}%`,
                  ...
                  {activeTool === "pointer" && selectedObjectId && bbox && (
                    <div
                      className="absolute border border-dashed border-[#EF0328] pointer-events-auto z-20 cursor-move"
                      style={{
                    ...
                    >
                      {/* Corner handles */}
                      <div
                        className="absolute -top-1.5 -left-1.5 w-3 h-3 bg-white border border-[#EF0328] cursor-nwse-resize rounded-full"
                        onMouseDown={(e) => handleStartResizeSelected(e, "tl")}
                      />
                      <div
                        className="absolute -top-1.5 -right-1.5 w-3 h-3 bg-white border border-[#EF0328] cursor-nesw-resize rounded-full"
                        onMouseDown={(e) => handleStartResizeSelected(e, "tr")}
                      />
                      <div
                        className="absolute -bottom-1.5 -left-1.5 w-3 h-3 bg-white border border-[#EF0328] cursor-nesw-resize rounded-full"
                        onMouseDown={(e) => handleStartResizeSelected(e, "bl")}
                      />
                      <div
                        className="absolute -bottom-1.5 -right-1.5 w-3 h-3 bg-white border border-[#EF0328] cursor-nwse-resize rounded-full"
                        onMouseDown={(e) => handleStartResizeSelected(e, "br")}
                      />

                      {/* Edge handles */}
                      <div
                        className="absolute -top-1.5 left-[calc(50%-6px)] w-3 h-3 bg-white border border-[#EF0328] cursor-ns-resize rounded-full"
                        onMouseDown={(e) => handleStartResizeSelected(e, "t")}
                      />
                      <div
                        className="absolute -bottom-1.5 left-[calc(50%-6px)] w-3 h-3 bg-white border border-[#EF0328] cursor-ns-resize rounded-full"
                        onMouseDown={(e) => handleStartResizeSelected(e, "b")}
                      />
                      <div
                        className="absolute top-[calc(50%-6px)] -left-1.5 w-3 h-3 bg-white border border-[#EF0328] cursor-ew-resize rounded-full"
                        onMouseDown={(e) => handleStartResizeSelected(e, "l")}
                      />
                      <div
                        className="absolute top-[calc(50%-6px)] -right-1.5 w-3 h-3 bg-white border border-[#EF0328] cursor-ew-resize rounded-full"
              ...
              <div className="mt-6 bg-[#1d1d1f]/90 backdrop-blur-md border border-white/10 px-4 py-2.5 rounded-2xl flex items-center gap-3 shadow-2xl z-20 select-none">
                {/* Pointer tool */}
                <button
                  onClick={() => {
                    setActiveTool("pointer");
                ...
                <div className="flex items-center gap-1.5 bg-[#212123]/90 px-2 py-1 rounded-xl border border-white/5">
                ...
                <button
                  ...
                  disabled={generating}
                  className="ml-1 bg-[#EF0328] hover:opacity-90 active:scale-[0.97] transition-all text-black font-extrabold text-xs px-4 py-2 rounded-xl flex items-center gap-1.5 shadow-md shadow-[#EF0328]/10 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {generating ? (
                    <>
        ...
        {viewState === "canvas" && (
          <div className="border-t border-white/5 p-4 shrink-0 bg-[#1d1d1f] flex items-center justify-between z-20">
            {/* Left Options */}
            <div className="flex items-center gap-2">
              <div className="relative" ref={modelDropdownRef}>
                <button
                  onClick={() => setIsModelDropdownOpen(!isModelDropdownOpen)}
                  className="h-[38px] flex items-center gap-2 px-3 bg-[#1d1d1f]/[0.98] hover:bg-[#1c1c22] rounded-xl border border-white/5 text-xs text-white/70 whitespace-nowrap shadow-xl"
                >
                  <span className="text-[10px] text-[#EF0328] font-black bg-white/[0.07] px-1.5 rounded border border-[#EF0328]/25">
                    G
                  </span>
                ...
                {isModelDropdownOpen && (
                  <div className="absolute bottom-[calc(100%+8px)] left-0 bg-[#1d1d1f] border border-white/10 rounded-2xl p-2 w-64 shadow-2xl flex flex-col gap-1 z-30">
                    ...
                    >
                      <div className="text-xs font-bold flex items-center gap-1.5">
                        Nano Banana 2 Edit
                        {selectedModel === "nano-banana-2-edit" && (
                          <span className="text-[#EF0328]">✓</span>
                        )}
                      </div>
              ...
              <div className="relative">
                <button
                  ...
                  className="h-[38px] w-[38px] flex items-center justify-center bg-[#1d1d1f]/[0.98] hover:bg-[#1c1c22] rounded-xl border border-white/5 text-white/60 shadow-xl transition-all"
                ...
                {showSettingsPopover && (
                  <div className="absolute bottom-[calc(100%+8px)] left-0 bg-[#1d1d1f] border border-white/10 rounded-2xl p-3.5 w-44 shadow-2xl flex flex-col gap-2 z-30">
                    ...
                    <input
                      ...
                      className="w-full h-1 bg-white/10 rounded-lg appearance-none cursor-pointer accent-[#EF0328]"
                    />
            ...
            <input
              ...
              className="flex-1 mx-3 h-[38px] bg-[#1d1d1f]/[0.98] border border-white/5 rounded-xl px-3 text-xs text-white/80 placeholder-white/25 outline-none focus:border-[#EF0328]/40 focus:ring-1 focus:ring-[#EF0328]/20 transition-all"
            />
            ...
            <div className="flex items-center gap-2">
              <div className="relative" ref={arDropdownRef}>
                ...
                {isArDropdownOpen && (
                  <div className="absolute bottom-[calc(100%+8px)] right-0 bg-[#1d1d1f] border border-white/10 rounded-xl p-2 w-36 max-h-72 overflow-y-auto shadow-2xl flex flex-col gap-1 z-30">
                    <div className="text-[10px] font-black text-white/30 uppercase tracking-widest p-1.5 pb-1 select-none">
                      Aspect Ratio
                    </div>
