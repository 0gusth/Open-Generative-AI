...
export const MODEL_TRUTH = [
  ...
  {
    match: /seedance[ @-]?(v?2)(\.0)?(?![.\d])/i, // Seedance 2.0 family
    aspects: ALL_ASPECTS,
    qualities: ["480p", "720p", "1080p", "4k"],
  ...
  {
    match: /kling[ -]?(v|video[ @]?|video@o)?3/i,
  ...
  {
    match: /gemini.*omni|omni-flash/i,
    aspects: ["16:9", "9:16"],
